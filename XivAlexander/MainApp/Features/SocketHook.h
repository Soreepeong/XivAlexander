...
namespace XivAlexander::Apps::MainApp::Features {
	...
	public:
		...
		typedef std::function<bool(xivres::network::message*)> MessageMangler;
	...
	public:
		...
		xivres::util::listener_manager<Implementation, void, SingleConnection&> OnSocketFound;
		xivres::util::listener_manager<Implementation, void, SingleConnection&> OnSocketGone;
