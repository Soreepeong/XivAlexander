...
XivAlexander::Apps::MainApp::Window::ConfigWindow::ConfigWindow(UINT nTitleStringResourceId, Config::BaseRepository* pRepository)
...
XivAlexander::Apps::MainApp::Window::ConfigWindow::~ConfigWindow() {
	Destroy();
}
...
LRESULT XivAlexander::Apps::MainApp::Window::ConfigWindow::WndProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
	switch (uMsg) {
