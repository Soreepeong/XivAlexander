...
namespace Sqex::FontCsv {
	...
	public:
		...
		virtual RECT MeasureAndDraw(_In_opt_ Texture::MemoryBackedMipmap* to, int x, int y, const std::string& s, Texture::RGBA8888 color = {0xFFFFFFFF}) const = 0;
	};
	...
	public:
		...
		RECT MeasureAndDraw(Texture::MemoryBackedMipmap* to, int x, int y, const std::string& s, Texture::RGBA8888 color = { 0xFFFFFFFF }) const override;
	};
}
