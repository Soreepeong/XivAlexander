...
void XivAlexander::Misc::ExcelTransformConfig::to_json(nlohmann::json& j, const PluralColumns& o) {
...
void XivAlexander::Misc::ExcelTransformConfig::from_json(const nlohmann::json& j, PluralColumns& o) {
	if (!j.is_array())
...
void XivAlexander::Misc::ExcelTransformConfig::to_json(nlohmann::json& j, const TargetGroup& o) {
	j = o.columnIndices;
}

void XivAlexander::Misc::ExcelTransformConfig::from_json(const nlohmann::json& j, TargetGroup& o) {
	o.columnIndices = j.get<decltype(o.columnIndices)>();
}

void XivAlexander::Misc::ExcelTransformConfig::to_json(nlohmann::json& j, const ReplacementTemplate& o) {
...
void XivAlexander::Misc::ExcelTransformConfig::from_json(const nlohmann::json& j, ReplacementTemplate& o) {
	o.from = j.at("from").get<std::string>();
	o.to = j.at("to").get<std::string>();
	o.icase = j.value("icase", true);
}

void XivAlexander::Misc::ExcelTransformConfig::to_json(nlohmann::json& j, const IgnoredCell& o) {
	j = nlohmann::json::object({
		{"name", o.name},
		{"id", o.id},
		{"column", o.column},
...
void XivAlexander::Misc::ExcelTransformConfig::from_json(const nlohmann::json& j, Rule& o) {
...
void XivAlexander::Misc::ExcelTransformConfig::to_json(nlohmann::json& j, const Config& o) {
	j = nlohmann::json::object({
		{"name", o.name},
...
void XivAlexander::Misc::ExcelTransformConfig::from_json(const nlohmann::json& j, Config& o) {
