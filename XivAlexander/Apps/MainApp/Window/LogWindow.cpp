...
void XivAlexander::Apps::MainApp::Window::LogWindow::ApplyLanguage(WORD languageId) {
...
void XivAlexander::Apps::MainApp::Window::LogWindow::OnLayout(double zoom, double width, double height, int resizeType) {
...
LRESULT XivAlexander::Apps::MainApp::Window::LogWindow::OnNotify(const LPNMHDR nmhdr) {
...
void XivAlexander::Apps::MainApp::Window::LogWindow::FlushLog(const std::string& logstr, LogLevel level) {
	RunOnUiThreadWait([&]() {
